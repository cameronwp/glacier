...
func (_m *BufferFetcherHasher) FetchAndHash(_a0 io.ReaderAt, _a1 string, _a2 int64, _a3 int64) (fs.FileChunk, error) {
	ret := _m.Called(_a0, _a1, _a2, _a3)

	var r0 fs.FileChunk
	if rf, ok := ret.Get(0).(func(io.ReaderAt, string, int64, int64) fs.FileChunk); ok {
